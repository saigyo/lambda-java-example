 ...
 * <p>
 * T type parameter is used to determine the Spring @Configuration class, thus T should be a class
 * that declares @Configuration annotation. Otherwise, an exception is thrown.
 *
 * @param <T>
 */
...
public abstract class AbstractHandler<T>
{
    ...
    /**
     * Every handler can override this String variable to provide an example event JSON for local
     * running
     */
    ...
    public AbstractHandler()
    {
         ...
         */
        Class typeParameterClass = ((Class) ((ParameterizedType) getClass().getGenericSuperclass()).getActualTypeArguments()[0]);
